namespace ToDoCalender
{
    partial class AddForm
    {
		...
		private void InitializeComponent()
		{
			...
			// clearDates
			// 
			clearDates.BackColor = Color.Orange;
			clearDates.Location = new Point(277, 399);
			clearDates.Name = "clearDates";
			clearDates.Size = new Size(94, 29);
			clearDates.TabIndex = 17;
			clearDates.Text = "Clear Dates";
			clearDates.UseVisualStyleBackColor = false;
			clearDates.Click += clearDates_Click;
			// 
			// AddForm
			// 
